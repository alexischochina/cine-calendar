...
export default defineNuxtConfig({
    ...
    vite: {
        ...
        css: {
            preprocessorOptions: {
                scss: {
                    additionalData: '@import "~/assets/styles/_variables.scss";@import "@/assets/styles/_typography-mixins.scss";@import "@/assets/styles/_functions.scss";@import "@/assets/styles/_transitions.scss";@import "@/assets/styles/_a11y.scss";',
