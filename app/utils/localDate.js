...
// la `Date` retombe la veille et un événement du 17 s'affiche « 16 août ».
//
// ⚠️ `parseYMD` de `useYearStats.js` n'est pas la même fonction malgré son nom : elle rend
// `{ year, month }` pour du regroupement.
