...
// Date locale `YYYY-MM-DD` à J+offset (offset négatif accepté). Pas de `toISOString()`, qui rend de
// l'UTC et bascule d'un jour en fin de soirée à Paris.
...
// Dernier mercredi 00 h en millisecondes (aujourd'hui même, s'il est mercredi). Toute donnée écrite
// avant est périmée quel que soit son âge : une entrée du mardi soir ne dit plus rien de la grille
// du mercredi matin.
export const lastWednesday = () => {
    const d = new Date();
    d.setHours(0, 0, 0, 0);
